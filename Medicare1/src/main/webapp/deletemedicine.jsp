...
<div class="text-center"><h2>Delete Medicine Details</h2></div>

<div class="margin-left=5"><h4><a href="Logout.jsp">Logout</a></h4></div>
  </div>
</nav>
<body>
<form action="deletemedicine"  method="post" enctype="multipart/form-data">

<tr><td><input type="hidden" name="id" value=<%=request.getParameter("id") %>></td></tr>

<tr><td><div class="text-center"><button type="submit" class="btn btn-primary">Delete</button></div></td></tr>
