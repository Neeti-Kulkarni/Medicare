...
<div class="text-center"><h2>Insert Product Details</h2></div>
...
<form action="insertmedicine" method="post" enctype="multipart/form-data">
...
<tr><td><div class="text-center"><button type="submit" class="btn btn-primary">Save </button></div></td></tr>
</table><br>
</form>
