...
<nav class="navbar navbar-light bg-light">
  ...
  <%String path2="E:/Neeti/img/med2.png";
...
<%@include file="usersearchmedicine.jsp" %>&nbsp 
...
<td>
<form action="addtocart.jsp" method="post" class="form-inline">
<input type="hidden" name="id" value=<%=m.getId()%> class="form-input">
<input type="hidden" name="name" value=<%=m.getName()%>>
<input type="hidden" name="category" value=<%=m.getCategory()%>>
